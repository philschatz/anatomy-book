...
The motor output from the cortex descends into the brain stem and to the spinal cord to control the musculature through motor neurons. Neurons located in the primary motor cortex, named **Betz cells**{: data-type="term"}, are large cortical neurons that synapse with lower motor neurons in the brain stem or in the spinal cord. The two descending pathways travelled by the axons of Betz cells are the **corticobulbar tract**{: data-type="term"} and the **corticospinal tract**{: data-type="term"}, respectively. Both tracts are named for their origin in the cortex and their targets—either the brain stem (the term “bulbar” refers to the brain stem as the bulb, or enlargement, at the top of the spinal cord) or the spinal cord.
...
[1]: http://openstax.org/l/motorpathway
[2]: http://openstax.org/l/NYTmotor
[3]: http://openstax.org/l/reflexarc
[4]: http://openstax.org/l/newreflex
