...
![This photo shows Phineas Gage holding the metal spike that impaled his prefrontal cortex.](../resources/1425_Phineas_Gage.jpg){: #phineasgage01 data-media-type="image/jpg"}

![The image on the right shows a drawing of the skull with the metal spike inserted like it would have been when he was injured.](../resources/Phineas_gage_-_1868_skull_diagram.jpg){: #phineasgage02 data-media-type="image/jpg"}
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/motorpathway.png){: data-media-type="image/png"} </span>
...
<div data-type="note" class="anatomy interactive" data-label="" markdown="1">
<span data-type="media" id="eip-id1525176" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/NYTmotor.png){: data-media-type="image/png"} </span>
...
<div data-type="note" class="anatomy interactive" data-label="" markdown="1">
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/reflexarc.png){: data-media-type="image/png"} </span>
...
<div data-type="note" class="anatomy interactive" data-label="" markdown="1">
<span data-type="media" id="eip-id2242005" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/newreflex.png){: data-media-type="image/png"} </span>
