...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/stomach1.png){: data-media-type="image/png"} </span>
...
![This flowchart shows the three different phases of gastric secretion. The top panel shows the cephalic phase, the middle panel shows the gastric phase and the bottom panel shows the intestinal phase.](../resources/2416_Three_Phases_Gastric_Secretion.jpg "Gastric secretion occurs in three phases: cephalic, gastric, and intestinal. During each phase, the secretion of gastric juice can be stimulated or inhibited."){: #fig-ch24_04_03 data-media-type="image/jpg" data-title="The Three Phases of Gastric Secretion "}
