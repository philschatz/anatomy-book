...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/vasectomy.png) </span>
Watch this [<u data-effect="underline">video</u>][1] to learn about a vasectomy. As described in this video, a vasectomy is a procedure in which a small section of the ductus (vas) deferens is removed from the scrotum. This interrupts the path taken by sperm through the ductus deferens. If sperm do not exit through the vas, either because the man has had a vasectomy or has not ejaculated, in what region of the testis do they remain?
...
<span data-type="media" id="eip-id1793514" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/spermpath.png) </span>
Watch this [<u data-effect="underline">video</u>][2] to explore the structures of the male reproductive system and the path of sperm, which starts in the testes and ends as the sperm leave the penis through the urethra. Where are sperm deposited after they leave the ejaculatory duct?
...
Watch this [<u data-effect="underline">video</u>][1] to learn about vasectomy. As described in this video, a vasectomy is a procedure in which a small section of the ductus (vas) deferens is removed from the scrotum. This interrupts the path taken by sperm through the ductus deferens. If sperm do not exit through the vas, either because the man has had a vasectomy or has not ejaculated, in what region of the testis do they remain?
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Watch this [ <u data-effect="underline">video</u>][2] to explore the structures of the male reproductive system and the path of sperm that starts in the testes and ends as the sperm leave the penis through the urethra. Where are sperm deposited after they leave the ejaculatory duct?
...
[1]: http://openstax.org/l/vasectomy
[2]: http://openstax.org/l/spermpath
