...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/capillaryfunct.png){: data-media-type="image/png"} </span>
