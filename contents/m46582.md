...
a URL"> ![QR Code representing a URL](../resources/fightflight.png){:
...
spinal cord to the different target organs. The target organs are listed
on the
...
<div data-type="exercise" id="fs-id1765597">
