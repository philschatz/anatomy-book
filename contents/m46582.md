...
: one of the receptors to which epinephrine and norepinephrine bind, which comes in three subtypes: α<sub>1</sub>, α<sub>2</sub>, and α<sub>3</sub>
^
...
: one of the receptors to which epinephrine and norepinephrine bind, which comes in two subtypes: β<sub>1</sub> and β<sub>2</sub>
^
...
[1]: http://openstax.org/l/fightflight
[2]: http://openstax.org/l/nervsystem1
