...
<div data-type="media" id="eip-id2047241" data-alt="QR Code representing a URL">
![QR Code representing a URL](../resources/ovulation.png)
</div>
Watch this [ <u> video</u>][1] to observe ovulation and its initiation in response to the release of FSH and LH from the pituitary gland. What specialized structures help guide the oocyte from the ovary into the uterine tube?
...
<div data-type="media" id="eip-id2210160" data-alt="QR Code representing a URL">
![QR Code representing a URL](../resources/oocyte.png)
</div>
Watch this series of [<u> videos</u>][2] to look at the movement of the oocyte through the ovary. The cilia in the uterine tube promote movement of the oocyte. What would likely occur if the cilia were paralyzed at the time of ovulation?
