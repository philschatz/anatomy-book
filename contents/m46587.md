...
<td>β-blockers such as propanolol or metaprolol; α-blockers such as clonidine</td>
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/3Dmovies.png){: data-media-type="image/png"} </span>
