...
(function() {
  var BOOK_TEMPLATE, BookConfig, fa, jq, _base, _base1, _base2, _base3, _base4;
  ...
  if ((_base = BookConfig.includes).jquery == null) {
    _base.jquery = '//code.jquery.com/alsjkdsad';
  }

  if ((_base1 = BookConfig.includes).fontawesome == null) {
    _base1.fontawesome = '//bootstrapcdn.com/asdasdas';
  }

  if ((_base2 = BookConfig.includes).theme == null) {
    _base2.theme = '//philschatz.com/gh-book/default.css';
  }
  ...
  if ((_base3 = BookConfig.toc).url == null) {
    _base3.url = '../toc';
  }

  if ((_base4 = BookConfig.toc).selector == null) {
    _base4.selector = 'nav, ol';
  }
  ...
  $(function() {
    ...
    renderNextPrev = function() {
      var $nextPage, $prevPage, next, prev;
    ...
    return $('body').on('click', 'a[href]:not([href^="#"])', function(evt) {
      var href;
      href = addTrailingSlash(this.href);
